...
class SwerveModuleConfigTest {
    ...
    void constructor_setsAllFieldsCorrectly() {
        SwerveModuleConfig config = new SwerveModuleConfig(
                1,
                2,
                3, // driveMotorId, steerMotorId, encoderId
                0.25, // encoderOffsetAngle (rotations)
                10.0,
                -10.0, // xPos, yPos (inches)
                true,
                false,
                true // invertSide, steerMotorInverted, encoderInverted
                );
    ...
    void encoderOffset_convertsToRotations() {
        ...
        SwerveModuleConfig config = new SwerveModuleConfig(1, 2, 3, offsetRotations, 0.0, 0.0, false, false, false);
    ...
    void position_convertsToInches() {
        double xInches = 11.5;
        double yInches = -11.5;
        SwerveModuleConfig config = new SwerveModuleConfig(1, 2, 3, 0.0, xInches, yInches, false, false, false);
    ...
    void encoderOffset_handlesNegativeValues() {
        ...
        SwerveModuleConfig config = new SwerveModuleConfig(1, 2, 3, negativeOffset, 0.0, 0.0, false, false, false);
    ...
    void constructor_handlesZeroValues() {
        SwerveModuleConfig config = new SwerveModuleConfig(0, 0, 0, 0.0, 0.0, 0.0, false, false, false);
    ...
    void inversionFlags_allCombinations() {
        // All false
        SwerveModuleConfig allFalse = new SwerveModuleConfig(1, 2, 3, 0.0, 0.0, 0.0, false, false, false);
        assertFalse(allFalse.invertSide);
        assertFalse(allFalse.steerMotorInverted);
        assertFalse(allFalse.encoderInverted);

        // All true
        SwerveModuleConfig allTrue = new SwerveModuleConfig(1, 2, 3, 0.0, 0.0, 0.0, true, true, true);
        ...
        SwerveModuleConfig rightSide = new SwerveModuleConfig(1, 2, 3, 0.0, 0.0, 0.0, true, false, false);
    ...
    void position_handlesNegativeCoordinates() {
        ...
        SwerveModuleConfig backRight = new SwerveModuleConfig(1, 2, 3, 0.0, -11.5, -11.5, false, false, false);
    ...
    void constructor_acceptsBoundaryEncoderOffset() {
        ...
        SwerveModuleConfig minOffset = new SwerveModuleConfig(1, 2, 3, -1.0, 0.0, 0.0, false, false, false);
        assertEquals(-1.0, minOffset.encoderOffset.in(Rotations), 0.0001);

        SwerveModuleConfig maxOffset = new SwerveModuleConfig(1, 2, 3, 1.0, 0.0, 0.0, false, false, false);
    ...
    void constructor_acceptsBoundaryCanIds() {
        ...
        SwerveModuleConfig minIds = new SwerveModuleConfig(0, 0, 0, 0.0, 0.0, 0.0, false, false, false);
        assertEquals(0, minIds.driveMotorId);

        SwerveModuleConfig maxIds = new SwerveModuleConfig(62, 62, 62, 0.0, 0.0, 0.0, false, false, false);
