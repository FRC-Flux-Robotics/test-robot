...
class ConstantsTest {
    ...
    void driveConstants_autoModeSpeed_isNegative() {
        ...
        assertTrue(
                Constants.DriveConstants.AutoModeSpeed < 0, "AutoModeSpeed should be negative for backward movement");
    }

    @Test
    void driveConstants_autoModeDriveTime_isPositive() {
        assertTrue(Constants.DriveConstants.AutoModeDriveTime > 0, "AutoModeDriveTime should be positive");
    }

    @Test
    void operatorConstants_controllerPorts_areValid() {
        assertTrue(
                Constants.OperatorConstants.DriverControllerPort >= 0, "Driver controller port should be non-negative");
        assertTrue(
                Constants.OperatorConstants.OperatorControllerPort >= 0,
    ...
    void operatorConstants_triggerThreshold_isValid() {
        ...
        assertTrue(threshold >= 0 && threshold < 1.0, "TriggerThreshold should be between 0 and 1");
    }
}
